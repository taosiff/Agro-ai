...
def test_demand_forecast_direct(district="Dhaka"):
    """Test the demand forecasting feature by directly using the AgroClimateAI class"""
    try:
        print(f"Initializing AgroClimateAI...")
        ai = AgroClimateAI()
        
        print(f"Testing demand forecasting for district: {district}")
        result = ai.predict_demand(district)
...
if __name__ == "__main__":
    ...
    success = test_demand_forecast_direct(district)
